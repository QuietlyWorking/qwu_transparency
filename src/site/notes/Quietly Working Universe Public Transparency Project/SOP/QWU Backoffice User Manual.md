...
>
> Generated: 2026-04-08 19:07 | Source version: 4.79
...
- **Chat Interface:** Custom web app using Claude Agent SDK
- **Per-Supporter CLAUDE.md:** Generated by Brand Guide Machine — brand voice, visual identity, guardrails
- **Approval Workflow:** Git-native PR-based. Draft branch → sandbox preview → approve → merge to production. Deploy options: now / tonight / scheduled.
...
- Visual audit: `.tmp/greencal-sandbox-audit.md`
...
*Last updated: 2026-04-08 19:07 (v4.79)*